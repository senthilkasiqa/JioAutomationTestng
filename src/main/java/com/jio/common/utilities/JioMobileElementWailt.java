...
public class JioMobileElementWailt extends FluentWait<MobileElement> {
	...
	public JioMobileElementWailt(MobileElement input) {
		super(input);
	}
	...
	public JioMobileElementWailt(MobileElement element,
	...
	public JioMobileElementWailt(MobileElement element, Clock clock,
	...
	public JioMobileElementWailt ignore(
			@SuppressWarnings("unchecked") Class<? extends RuntimeException>... exceptionType) {
		return (JioMobileElementWailt) ignoreAll(ImmutableList.copyOf(exceptionType));
	}
